...
The ability to store inputs and outputs over longer timescales allows the DNC to operate on the data itself and learn what model best describes the relation between the inputs and outputs \cite{Graves}.
...
Current problems that DNCs are applied to are graph traversal and graph optimization problems.
We will do further research to select more complicated datasets, but we may generate our own as well.
